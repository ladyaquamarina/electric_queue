...
public class KafkaConfig {
    ...
    @Bean
    public ConcurrentKafkaListenerContainerFactory<String, PetitionDto> petitionKafkaListenerContainerFactory() {
        ConcurrentKafkaListenerContainerFactory<String, PetitionDto> factory = new ConcurrentKafkaListenerContainerFactory<>();
        factory.setConsumerFactory(petitionConsumerFactory());
        return factory;
    }

    @Bean
    public ConsumerFactory<String, PetitionDto> petitionConsumerFactory() {
        return new DefaultKafkaConsumerFactory<>(consumerConfig(),
                new StringDeserializer(),
                new JsonDeserializer<>(PetitionDto.class, false));
    }
...
//        ));
    ...
    @Bean
    public ProducerFactory<String, PetitionDto> producerFactory() {
...
//        ));
    ...
    @Bean
    KafkaTemplate<String, PetitionDto> petitionKafkaTemplate() {
        KafkaTemplate<String, PetitionDto> template = new KafkaTemplate<>(producerFactory());
        template.setConsumerFactory(petitionConsumerFactory());
        return template;
    }
}
